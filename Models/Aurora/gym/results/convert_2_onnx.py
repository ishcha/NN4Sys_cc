import sys 
sys.path.append('../')
from model import CustomNetwork_mid, CustomNetwork_big, CustomNetwork_mid_policy_net
import torch

model_name = 'pcc_model_mid_10_best (2)'

model = CustomNetwork_mid_policy_net()
